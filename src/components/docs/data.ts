  ...
  return [
  {
    ...
    params: [
      ...
      },
      {
        ...
        required: false,
        default: 'false',
        description: 'When true, robots.txt rules are NOT enforced — the crawler ignores all Disallow rules. Default: false (follow robots.txt). The frontend shows a legal risk warning dialog when the user tries to disable this. AI opt-out layers (X-Robots-Tag: noai, <meta> robots, CC-NOAI, TDM-Rep) are NEVER bypassable — they are hard legal compliance.',
      },
      {
        name: 'followNofollow',
        type: 'boolean',
        required: false,
        default: 'false',
        description: 'When true, links with rel="nofollow" are treated as regular links and followed. Default: false (respect nofollow). When false, links marked rel="nofollow" are filtered out from the results. Also checks <meta name="robots" content="nofollow"> at the page level — when present, ALL links on that page are treated as nofollow.',
      },
      {
