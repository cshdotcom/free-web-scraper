 ...
 * e.g. "NodeByte Crawl/4.0.0 (+https://nodebyte.cn)"
 ...
 *   "Mozilla/5.0 (compatible; NodeByte Bot/4.0.0; +https://nodebyte.cn)"
 *
...
export function pickDeviceProfile(device: DeviceType = 'auto'): DeviceProfile {
  ...
  //   Mozilla/5.0 (iPhone; ...; compatible; NodeByte Bot/4.0.0; +https://nodebyte.cn)
