 ...
 * e.g. "NodeByte Crawl/3.8.8P (+https://nodebyte.cn)"
 ...
 *   "Mozilla/5.0 (compatible; NodeByte Bot/3.8.8P; +https://nodebyte.cn)"
 *
...
export function pickDeviceProfile(device: DeviceType = 'auto'): DeviceProfile {
  ...
  //   Mozilla/5.0 (iPhone; ...; compatible; NodeByte Bot/3.8.8P; +https://nodebyte.cn)
